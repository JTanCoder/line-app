<template>
	<view class="fuled-picker-view">
		<picker-view  class="d-picker-view" :indicator-style="itemHeight" :value="pickVal" @change="handlerChange">
			<picker-view-column class="fuled-picker-flex2">
				<view class="fuled-picker-item" v-for="(item,index) in range.fyears" :key="index">{{item}}年</view>
			</picker-view-column>
			<picker-view-column class="fuled-picker-flex2">
				<view class="fuled-picker-item" v-for="(item,index) in range.fmonths" :key="index">{{item}}月</view>
			</picker-view-column>
			<picker-view-column class="fuled-picker-flex2">
				<view class="fuled-picker-item" v-for="(item,index) in range.fdays" :key="index">{{item}}日</view>
			</picker-view-column>
			<picker-view-column class="fuled-picker-flex1">
				<view class="fuled-picker-item">-</view>
			</picker-view-column>
			<picker-view-column class="fuled-picker-flex2">
				<view class="fuled-picker-item" v-for="(item,index) in range.tyears" :key="index">{{item}}年</view>
			</picker-view-column>
			<picker-view-column class="fuled-picker-flex2">
				<view class="fuled-picker-item" v-for="(item,index) in range.tmonths" :key="index">{{item}}月</view>
			</picker-view-column>
			<picker-view-column class="fuled-picker-flex2">
				<view class="fuled-picker-item" v-for="(item,index) in range.tdays" :key="index">{{item}}日</view>
			</picker-view-column>
		</picker-view>
	</view>
</template>
