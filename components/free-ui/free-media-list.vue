<template>
	...
	<div class="flex align-stretch" @click="onClick" @longpress="long">
		<view class="flex align-center justify-center position-relative" style="width: 145rpx;">
			...
			<free-badge badgeClass="position-absolute" badgeStyle="top:15rpx;right:1rpx" v-if="item.noreadnum" :value="item.noreadnum"></free-badge>
		</view>
		<view class="flex flex-column border-bottom flex-1 py-3 pr-3 border-light-secondary">
			...
			<text class="font text-ellipsis text-light-muted" style="width: 335rpx;">{{item.data}}</text>
		</view>
	</div>
	</view>
</template>
