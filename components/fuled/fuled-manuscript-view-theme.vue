		...
		<uni-drawer :visible="showLeft" mode="left" >
			<view class="page"  >
				...
				<view class="uni-bar-body">
					<uni-nav-bar :fixed="false" :border="false" backgroundColor="#58B7E9" left-icon="arrowleft" color="#fff" left-text="返回" :title="'编辑主题'" @clickLeft="hide" background-color="#FFFFFF" >
					</uni-nav-bar>
				</view>
				<view class="uni-common-mt">
					<form >
						<view class="border-bottom pl-2 pb-2">
							...
							<input placeholder="请输入标题" v-model="currTheme.title"  name="currTheme.titleName" ></input>
						</view>
						<view class="border-bottom pl-2 pb-2">
							<view class="title pb-1" style="color: #C9C9C9;">副标题</view>
							<input placeholder="请输入副标题"  v-model="currTheme.subtitle" name="currTheme.subTitleName"></input>
						</view>
						<view class="uni-btn-v">
							<button style="background-color: #58B7E9;border-radius: 0;" @click="saveThemeMsg">确定</button>
						</view>
					</form>
				</view>
			</view>
